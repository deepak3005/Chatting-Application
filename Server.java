...
public class Server implements ActionListener
{
    ...
    Server()
    {
       ...
       ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("Image/user.png"));
       ...
       ImageIcon i11 = new ImageIcon(ClassLoader.getSystemResource("Image/phone.png"));
       ...
       ImageIcon i14 = new ImageIcon(ClassLoader.getSystemResource("Image/3icon.png"));
